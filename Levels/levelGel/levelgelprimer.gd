...
func _on_enemy_dead() -> void:
	...
	if numEnemies == 0:
		...
		print(" no enemies gel")
		GlobalValues.EndLevelInfo("Clima",GlobalValues.monedesCapturadesCurrentLevel, GlobalValues.TimeElapsedFinishLevel)		
		#NivellAcabat.emit()
		get_tree().change_scene_to_file("res://game_singleplayerGelBigBoss.tscn")	
	pass # Replace with function body.
